                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 mx-auto">
                            <h2>Introductie</h2>
                            <p>
                                Voor dit project wilde ik leren om aesthetically pleasing websites te maken. Hiervoor heb ik mij eerst verdiept in de theorie over kleur, lay-out, hiërarchie en typografie. Vervolgens heb ik daarmee geoefend en heb ik als laatste deze kennis toegepast om een herontwerp prototype te maken van de website van Bar Mokum.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 mx-auto">
                            <h2>Eindresultaat</h2>
                            <p>
                                Het prototype herontwerp is in vele opzichten verbeterd ten opzichte van de huidige website. Dit heb ik bereikt door het toepassen van passende kleuren, typografie, illustraties en de juiste hiërarchie. Dit alles heeft ervoor gezorgd dat de website een klassieke, maar ook frisse uitstraling heeft, en een mooie vertaling is van hoe Bar Mokum eruit ziet en waar Bar Mokum voor staat.
                            </p>
                        </div>
                    </div>

                    <div class="row justify-content-center" id="lightgallery">
                        <a href="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-1.png" class="col-12 col-lg-8 mx-auto mb-5">
                            <img src="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-1.png" alt="Mockup 1" class="img-fluid" />
                        </a>
                        <a href="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-2.png" class="col-12 col-lg-8 mx-auto mb-5">
                            <img src="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-2.png" alt="Mockup 2" class="img-fluid" />
                        </a>
                        <a href="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-3.png" class="col-12 col-lg-8 mx-auto">
                            <img src="assets/images/portfolio/calvin/bar-mokum/bar-mokum-macbook-mockup-3.png" alt="Mockup 3" class="img-fluid" />
                        </a>
                    </div>
                </div>
            </section>
