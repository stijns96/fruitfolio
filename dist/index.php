...
<link rel="stylesheet" href="assets/css/pages/home/home.min.css">
  ...
  ?>
    ...
    <main>
        <section id="landing">
            <div class="container-fluid">
                <div class="row nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <div class="col-12 col-md-3 character" id="<?php echo $user['id']; ?>" href="#<?php echo $user['id']; ?>-tab" role="tab" aria-controls="nav-home" aria-selected="true">
                        <div class="user-anim">
                            <div class="<?php echo $user['id']; ?> animation"></div>
                        </div>
        ...
        <div class="tab-content" id="portfolio">
            <div class="tab-pane" id="stijn-tab" role="tabpanel" aria-labelledby="nav-contact-tab">
                <section class="hero">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2><?php echo $CONFIG['USERS']['Stijn']['name'] ?></h2>
                                <span><?php echo $CONFIG['USERS']['Stijn']['job'] ?></span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-8 mx-auto text-center">
                                <p>
                                    Tijdens deze minor heb ik aan drie verschillende leerdoelen gewerkt. Per leerdoel kreeg je vijf weken om dit doel te bereiken. De doelen die ik heb gekozen hebben allemaal te maken met programmeren. Zo heb ik een CRUD Database, Login Systeem en een JAMstack website gemaakt.
                                </p>
                            </div>
                        </div>
            ...
            <div class="tab-pane" id="andrew-tab" role="tabpanel" aria-labelledby="nav-home-tab">
                <section class="hero">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2><?php echo $CONFIG['USERS']['Andrew']['name'] ?></h2>
                                <span><?php echo $CONFIG['USERS']['Andrew']['job'] ?></span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="intro">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-lg-8 mx-auto text-center">
                                <p>De afgelopen 15 weken heb ik gewerkt aan drie projecten. Het eerste project was het leren maken van logo’s. Het tweede project was het leren maken van een eigen lettertype en het derde project heb ik een echte website gemaakt voor een makelaar. Onderstaand staan de projecten waar ik aan heb gewerkt.</p>
                            </div>
                        </div>
            ...
            <div class="tab-pane" id="calvin-tab" role="tabpanel" aria-labelledby="nav-profile-tab">
                <section class="hero">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2><?php echo $CONFIG['USERS']['Calvin']['name'] ?></h2>
                                <span><?php echo $CONFIG['USERS']['Calvin']['job'] ?></span>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="tab-pane" id="shantusha-tab" role="tabpanel" aria-labelledby="nav-contact-tab">
                <section class="hero">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <h2><?php echo $CONFIG['USERS']['Shantusha']['name'] ?></h2>
                                <span><?php echo $CONFIG['USERS']['Shantusha']['job'] ?></span>
                            </div>
                        </div>
                    </div>
                </section>
